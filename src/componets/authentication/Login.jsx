...
import "../../index.css";
import { ThemeContext } from "../context/themeContext";
import { AiOutlineEye, AiOutlineEyeInvisible } from "react-icons/ai"; // 👈 NUEVO
          ...
          <div className="p-6 space-y-4 max-width-[448px] md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleLogin}>
              <div>
                <label
                  htmlFor="email"
                  className="block mb-2 text-lg text-white font-Horatio"
                >
                  Usuario
                </label>
                <input
              ...
              <div className="flex justify-center">
                <button
                  onClick={handleLogin}
                  className="w-4/5 text-white bg-naranjaCreame focus:outline-none focus:scale-95 transition font-medium rounded-lg text-sm px-5 py-2.5 text-center focus:shadow-inner-lg-red-500 "
                >
                  Iniciar
                </button>
              </div>
